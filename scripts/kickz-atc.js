...
let url_personal = ''; let version = ''; let discord_name = ""
...
let size_product = ""; let sku_product = ""; let price_product = ""
...
async function checkRes(response) {
    ...
    if (status == 200 || status == 201) {
        if (res != null || res != "") {
            ...
            //open("https://www.kickz.com/" + countryy + "/checkout/reserveBasketItemsAjax/timestamp/" + new Date().getTime(), "_self")
        }
        else {
