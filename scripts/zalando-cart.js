...
async function checkRescheckoutBuyNow(response) {
    ...
    try {
        ...
        if (status == 200 || status == 201) {
            ...
            } else if (url == "/cart?error=zalando.checkout.confirmation.quantity.error") {} else if (url == "/checkout/confirm?error=zalando.checkout.confirmation.quantity.error") {} else if (url.startsWith("https://checkout.payment.zalando.com/3ds")) {
